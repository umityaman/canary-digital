      ...
      <div className="mb-6">
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-neutral-600 mt-1">Üyeleri ve rolleri yönetin</p>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-4 mb-6">
          ...
          <div className="bg-white p-4 rounded-xl border border-neutral-200">
            <div className="text-neutral-600 text-xs mb-1">Yönetici</div>
            <div className="text-2xl font-bold text-neutral-900">{stats.admin}</div>
          </div>
          <div className="bg-white p-4 rounded-xl border border-neutral-200">
            <div className="text-neutral-600 text-xs mb-1">Satıcı</div>
            <div className="text-2xl font-bold text-neutral-900">{stats.seller}</div>
          </div>
          <div className="bg-white p-4 rounded-xl border border-neutral-200">
            <div className="text-neutral-600 text-xs mb-1">Müşteri</div>
