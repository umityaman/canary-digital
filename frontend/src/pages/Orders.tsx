        ...
        <div className="bg-white border-b border-neutral-200 px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-2xl font-semibold text-neutral-900">Kiralamalar</h1>
            </div>
            ...
            <div className="p-4 space-y-4">
              ...
              <div className="border-t border-neutral-200 pt-4">
                ...
                {dateRangeOpen && (
                  <div className="space-y-1">
                    ...
                    {/* Custom Date Picker */}
                    {dateRange === 'custom' && (
                      <div className="mt-2 p-2 bg-neutral-50 rounded-lg space-y-2">
                        <div>
                          ...
                          <input
                            ...
                            className="w-full px-2 py-1 text-xs border border-neutral-300 rounded focus:outline-none focus:ring-1 focus:ring-neutral-500"
                          />
                        </div>
                        <div>
                        ...
                        <button
                          ...
                          className="w-full px-2 py-1 text-xs text-neutral-600 hover:text-neutral-900 hover:bg-neutral-100 rounded"
                        >
                          Temizle
                        </button>
                      </div>
                ...
                {customerFilterOpen && (
                  <div className="space-y-1 max-h-48 overflow-y-auto">
                    <button
                      ...
                      className={`w-full text-left px-2 py-1.5 text-sm rounded hover:bg-neutral-50 transition-colors ${
                        selectedCustomerFilter === null ? 'bg-blue-50 text-blue-700 font-medium' : 'text-neutral-700'
                      }`}
                    >
                    ...
                    {uniqueCustomers.map(customer => {
                      ...
                      return (
                        <button
                          ...
                          className={`w-full text-left px-2 py-1.5 text-sm rounded hover:bg-neutral-50 transition-colors flex items-center justify-between ${
                            selectedCustomerFilter === customer.id ? 'bg-blue-50 text-blue-700 font-medium' : 'text-neutral-700'
                          }`}
                        >
              ...
              <div className="border-t border-neutral-200 pt-4">
                <button 
                  ...
                  className="w-full flex items-center justify-center gap-2 px-4 py-2 border border-neutral-300 rounded-lg text-sm text-neutral-700 hover:bg-neutral-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
            ...
            <div className="flex-1 overflow-y-auto p-6">
              ...
              <div className="grid grid-cols-4 gap-4 mb-6">
                <div className="bg-white rounded-xl border border-neutral-200 p-6">
                  <div className="text-sm text-neutral-600 mb-1">Kiralamalar</div>
                  <div className="text-3xl font-bold text-neutral-900">{stats.orders}</div>
                </div>
                
                <div className="bg-white rounded-xl border border-neutral-200 p-6">
                  <div className="text-sm text-neutral-600 mb-1">Kiralanan Ürünler</div>
              ...
              <div className="bg-white rounded-xl border border-neutral-200 overflow-hidden">
                ...
                {selectedOrders.length > 0 && (
                  <div className="border-b border-neutral-200 px-6 py-3 bg-blue-50 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-2">
                      <div className="relative">
                        <button
                          ...
                          className="px-4 py-2 text-sm font-medium text-neutral-700 bg-white border border-neutral-300 rounded-lg hover:bg-neutral-50 flex items-center gap-2"
                        >
                          Durumu Güncelle
                        ...
                        {showBulkActions && (
                          <div className="absolute right-0 top-full mt-2 w-48 bg-white border border-neutral-200 rounded-lg shadow-lg z-10">
                            <button
                              onClick={() => handleBulkStatusUpdate('reserved')}
                              className="w-full px-4 py-2 text-left text-sm hover:bg-neutral-50 first:rounded-t-lg"
                            ...
                            <button
                              ...
                              className="w-full px-4 py-2 text-left text-sm hover:bg-neutral-50 last:rounded-b-lg"
                              disabled={bulkActionLoading}
                            >
                ...
                {loading && (
                  <div className="p-12 text-center">
                    ...
                    <p className="mt-4 text-neutral-600">Kiralamalar yükleniyor...</p>
                  </div>
                )}
                ...
                {error && !loading && (
                  <div className="p-12 text-center">
                    ...
                    <p className="text-neutral-900 font-medium mb-2">Kiralamalar yüklenemedi</p>
                ...
                {!loading && !error && sortedOrders.length > 0 ? (
                        ...
                        <tr>
                          ...
                          <th className="px-6 py-3 text-left">
                            <button
                              ...
                              className="flex items-center gap-1 text-xs font-semibold text-neutral-700 uppercase hover:text-neutral-900"
                            >
                              Tarih
                              {sortBy === 'date' && (
                          ...
                          <th className="px-6 py-3 text-left">
                            <span className="text-xs font-semibold text-neutral-700 uppercase">Kiralama #</span>
                          </th>
                          <th className="px-6 py-3 text-left">
                            <button
                          ...
                          <th className="px-6 py-3 text-left">
                            <span className="text-xs font-semibold text-neutral-700 uppercase">Ödeme</span>
                          </th>
                          <th className="px-6 py-3 text-right">
                            <button
                              onClick={() => handleSort('total')}
                              className="flex items-center gap-1 text-xs font-semibold text-neutral-700 uppercase hover:text-neutral-900 ml-auto"
                            >
                              Toplam
                              {sortBy === 'total' && (
                                <span>{sortOrder === 'asc' ? '↑' : '↓'}</span>
                          ...
                          <tr key={order.id} className="hover:bg-neutral-50">
                            ...
                            <td className="px-6 py-4">
                              <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                                ...
                                order.status?.toUpperCase() === 'COMPLETED' || order.status?.toLowerCase() === 'returned' ? 'bg-neutral-100 text-gray-800' :
                  ...
                  <div className="p-12 text-center">
                    ...
                    <h3 className="text-xl font-semibold text-neutral-900 mb-2">İlk kiralamanızı oluşturun</h3>
                    <p className="text-neutral-600 mb-1">Canlı müsaitlik ve otomatik fiyat hesaplamaları ile kiralamalarınızı oluşturun ve yönetin.</p>
                    <p className="text-neutral-600 mb-6">Ardından, iş akışına aşina olmak için bir kiralamataki öğeleri rezerve etmeyi, almayı ve iade etmeyi deneyin.</p>
                    <button
                      onClick={() => setShowForm(true)}
