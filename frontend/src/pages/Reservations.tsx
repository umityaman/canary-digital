                ...
                {dateRangeOpen && (
                  <div className="space-y-1">
                    <div 
                      ...
                      className="text-sm text-neutral-700 px-2 py-1.5 hover:text-blue-600 cursor-pointer transition-colors"
                    >
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black bg-opacity-25" onClick={() => setShowDatePicker(false)}>
        <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl" onClick={(e) => e.stopPropagation()}>
          <div className="flex">
            ...
            <div className="w-40 border-r border-neutral-200 p-3">
            ...
            <div className="flex-1 p-4">
              ...
              <div className="flex items-center justify-between mb-3">
                ...
                <h3 className="text-sm font-semibold text-neutral-900">Ekim 2025</h3>
                <button className="p-1 hover:bg-neutral-100 rounded">
                  <ChevronDown className="w-4 h-4 -rotate-90 text-neutral-600" />
                </button>
              </div>
              ...
              <div className="grid grid-cols-2 gap-2 pt-3 border-t border-neutral-200">
                <div>
                  <label className="block text-xs font-medium text-neutral-700 mb-1">Başlangıç</label>
                  <input 
                    type="text"
                    value={customDateFrom ? new Date(customDateFrom).toLocaleDateString('tr-TR') : ''}
                    readOnly
                    placeholder="Seç..."
                    className="w-full px-2 py-1.5 text-xs border border-neutral-300 rounded focus:outline-none focus:ring-1 focus:ring-neutral-500 bg-white"
                  />
                </div>
                <div>
                  <label className="block text-xs font-medium text-neutral-700 mb-1">Bitiş</label>
                  <input 
                    type="text"
