...
// Generate invoice PDF as base64 string (for email)
export const generateInvoicePDFBase64 = (data: InvoiceData): string => {
  const doc = new jsPDF();
...
// Generate offer PDF as base64 string (for email)
export const generateOfferPDFBase64 = (data: OfferData): string => {
  const doc = new jsPDF();
